...
{ 
  ...
  double true_u  = 0.215443;
  double true_mg  = 0.54117;
  
  /* Initialize libglobes */
  glbInit(argv[0]);
  glbDefineChiFunction(&chiLSND,     3/*2*/,        "chiLSND",     NULL);
 ...
 glbInitExperiment("LSND.glb",&glb_experiment_list[0],&glb_num_of_exps); 
  ...
  char* MYFILE="./results/lsnd-ev-teste2.dat";
  //ev-decay-m-comb.dat"; 
  FILE* stream;
  if(strlen(MYFILE)>0) stream=fopen(MYFILE, "w+");
   ...
   char* MYFILE2="./results/lsnd-chi-teste2.dat";
   //chi-decay-lsnd-m.dat"; 
   FILE* gabi;
