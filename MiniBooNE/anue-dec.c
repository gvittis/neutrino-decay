...
{ 
 ...
 loadminus();
  ...
  double true_u  = 0.2154;
  double true_mg  = 0.5411;
...
// Cria a variável que me auxiliará a levar os dados do mini_boone para a sistematica.
  ...
  glbSetRates();
   ...
   char* MYFILE="./results/ev-decay-mb-anue-m-comb.dat"; 
   FILE* stream;
   ...
   char* MYFILE2="./results/chi-decay-mb-anue-m.dat"; 
   FILE* gabi;
   ...
   double k,l,chi2;
    ...
    for(k=-4;k <= 0;k=k+4.0/70)
    for(l=-2;l <= 2.0;l=l+4.0/70){  
