...
{ 
 ...
 loadplus();
  ...
  double true_u  = 0.857696;
  double true_mg  = 0.215443;
 ...
 glbInitExperiment("MB_nue_only_decay.glb",&glb_experiment_list[0],&glb_num_of_exps); 
...
// Cria a variável que me auxiliará a levar os dados do mini_boone para a sistematica.
  ...
  glbSetRates();
   ...
   char* MYFILE="./results/ev-decay-mb-nue-m.dat"; 
   FILE* stream;
   ...
   char* MYFILE2="./results/chi-decay-mb-nue-m.dat"; 
   FILE* gabi;
