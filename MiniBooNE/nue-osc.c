...
int main(int argc, char *argv[])
{
 ...
 //readcov();
  ...
  double true_thetame = asin(sqrt(0.831))/2;
  double true_stdm = 0.036;
 ...
 glbInitExperiment("MB_nue_osc.glb",&glb_experiment_list[0],&glb_num_of_exps);  
...
/* double ener=0;
  ...
  /* char* MYFILE=""; */ 
   char* MYFILE="./results/ev-osc-mb-nue.dat"; /* if empty, write to screen, otherwise to file name given here */
   FILE* stream;
...
/*  fprintf(stream,"Simulated rates, experiment 0, rule 0: \n"); */
 ...
 /* char* MYFILE1="./results/chi-osc-mb-nue2.dat";
  FILE* gabi;
