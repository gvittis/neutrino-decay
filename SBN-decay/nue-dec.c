...
#include "./detectors/SBND/nu-mode.h"
#include "./detectors/MicroBooNE/nu-mode.h"
#include "./detectors/ICARUS/nu-mode.h"
...
{ 
 ...
 loadplus3();
  ...
  double true_u  = pow(10,-2.06667); //0.004;
  double true_mg  = pow(10,0.466667); //20;
...
// Cria a variável que me auxiliará a levar os dados do mini_boone para a sistematica.
 ...
 /*  char* MYFILE="./results/ev-decay-sbnd-nue-m.dat"; 
   FILE* stream;
   if(strlen(MYFILE)>0) stream=fopen(MYFILE, "w+");
    ...
    double *true_rates_N = glbGetSignalRatePtr(2, 0);
   ...
   char* MYFILE2="./results/chi-decay-sbn-nue-bf-m.dat"; 
   FILE* gabi;
